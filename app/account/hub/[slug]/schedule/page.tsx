...
function isOccurrenceOnDate(p: PgProgram, dateStr: string): boolean {
  ...
  // Monthly / daily — exact date match only
...
export default async function HubSchedulePage({
  ...
  // Fetch programs and assignments in parallel
  ...
  // Build assignment lookup: "programSlug::YYYY-MM-DD" -> assignment
  ...
  // Compute all occurrences in this month and merge with assignments
