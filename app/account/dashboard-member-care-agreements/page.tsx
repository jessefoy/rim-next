export const metadata = { title: "Member Care Agreements — Rooted In Mindfulness" };
          ...
          <div className="content-container">
            <div className="diversity-content-box">
              <div className="rich-text-block-15 w-richtext">
                ...
                <p>
                  At Rooted In Mindfulness (RIM), we strive to create a culture that is deeply
                  intentional, accepting, easygoing, and friendly. In order to foster a safe and
                  supportive environment, we ask everyone who joins RIM to agree to the following
                  four shared intentions. These agreements enable us to co-create a refuge for deep
                  learning, practice, and friendship.
                </p>
                <h5>
                ...
                <p>
                  ...
                  community. As a living expression of generosity, RIM is 100% community-funded and
                  entirely dependent on donations. These donations cover all operating costs,
                ...
                <p>
                  ...
                  contribute to the financial health of our precious center with an ongoing donation
                  amount (RIM Dana) that feels right to them. When deciding on ongoing financial
                  support, please be mindful of what stirs in your heart, your financial ability,
                  and the value the RIM community and teachings have in your life.
                </p>
                <h5>
