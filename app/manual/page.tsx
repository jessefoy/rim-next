/**
 * /manual — Public volunteer manual index (no auth required)
 * Same index as /admin/manual but without edit controls.
 */
...
export default async function PublicManualPage() {
