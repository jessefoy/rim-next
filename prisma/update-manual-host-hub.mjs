...
<p>Right now the team has Maria as the host coordinator. She's the person you go to with questions, scheduling problems, anything tricky that comes up in a session, or anything you're not sure about.</p>
...
<p>Jesse is RIM's guiding teacher. He's available for things that need a teacher's attention — a participant in crisis, a complicated pastoral situation, anything that feels bigger than a host's role. For most things, Maria is the right person to ask.</p>
...
<li><em>For Coordinators</em> — Maria's working materials</li>
</ul>
<p><strong>Members.</strong> Who's on the team, and whether they're active, paused, or away. Maria uses this to manage the team; you can use it to see who else is hosting.</p>
...
<tr><td>Reach Maria</td><td>Conversations, or message her directly</td></tr>
</tbody>
</table>
...
<p>If something here doesn't make sense, or you can't find what you're looking for, or anything feels confusing — message Maria. The hub is meant to make hosting easier, not harder. If it isn't doing that yet, that's worth fixing.</p>
