...
export async function seedManualProgramManager(db) {
  ...
  const body = [
    ...
    sp(),
    p(b("Schedule"), " — When and where. Set the format (in-person, virtual, hybrid), venue, start/end dates, and recurrence pattern. For virtual programs, you can enable Open Access to generate a guest join link."),
    sp(),
    ...
    sp(),
    p(b("Dashboard"), " — What members see on their dashboard card. Add announcements, early arrival messages, and set which days of the week the program meets."),
    sp(),
