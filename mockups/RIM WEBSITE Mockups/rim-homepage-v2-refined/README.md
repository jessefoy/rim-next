# Rooted in Mindfulness — Refined Site Concept
...
This version introduces a calmer typographic scale, changes the display face to Newsreader, restores category-led program groups, restores a date-led weekly schedule, combines overlapping homepage sections, and strengthens mobile proportions.

See `DESIGN-REVIEW.md` for the full rationale, type scale, spacing system, and page-by-page notes.
