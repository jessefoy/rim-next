 ...
 *
 * (The session-165 `openToAll` Community-Space primitive was removed when the
 * Community Space was retired — every Space is now stewarded with a real
 * roster, so access is purely membership OR GT.)
 */
