...
| `components/session/RIMControlBar.tsx` | Bottom control bar: mic/cam, Participants, Chat, Share (+ primer), Reactions, Settings, Bell mode, End. **Mute hotkeys** (session 147): `M` toggle (all), hold-`Space` push-to-talk (co-hosts) |
